...
@section('title', $state->name . ' Construction Experts - FindExpert')

@section('content')
<div class="container py-5">
    <div class="row">
        <div class="col-12">
            <h1 class="mb-4">Construction Experts in {{ $state->name }}</h1>
            <p class="lead">Find professional construction experts, builders, electricians, plumbers and more in {{ $state->name }}, Nigeria.</p>
        </div>
    </div>
        ...
        @empty
            <div class="col-12">
                <div class="text-center py-5">
                    ...
                    <h4>No experts found in {{ $state->name }}</h4>
